  ...
  return (
    <Container containerStyles="p-24 pt-8">
      <div className="space-y-4">
        ...
        <p>
          These Terms and Conditions (the “Terms”) apply to your use of the Ask
          Nina website, application, and related services (the “Services”).
          These Terms form an agreement between you and Cookout Ventures LLC, a
          Delaware company (the “Company,” “we,” or “us”), and they include our
          Service Terms and important provisions for resolving disputes through
        ...
        <p>
          ...
          Privacy Policy as well, which is an important document that you should
          read.
        </p>
        ...
        <p>
          ...
          are under 18 you must have your parent or legal guardian’s permission
          to use the Services.
        </p>
        <p>
          <b>Registration.</b>
          Should you choose to register for an account to use our Services, you
          must provide accurate and complete information when you do so. You may
        ...
        <h2>Content</h2>
        <p>
          <b>Your Content.</b> You may provide input to the Services (“Input”),
        ...
        <p>
          <b>Ownership of Content.</b> As between you and us, and to the extent
        ...
        <p>
          ...
          artificial intelligence generally, output may not be unique and other
          users may receive similar output from our Services. Our assignment
        ...
        <p>
          ...
          develop, and improve our Services, comply with applicable law, enforce
          our terms and policies, and keep our Services safe.
        </p>
        <p>
        ...
        <p>
          ...
          rapidly evolving fields of study. We are constantly working to improve
          our Services to make them more accurate, reliable, safe, and
          beneficial. Given the probabilistic nature of machine learning, use of
          our Services may, in some situations, result in Output that does not
        ...
        <ul>
          <li>
            ...
            from our Services as a sole source of truth or factual information,
            or as a substitute for professional advice.
          </li>{" "}
          <li>
            You must evaluate Output for accuracy and appropriateness for your
            use case, including using human review as appropriate, before using
            or sharing Output from the Services.
          </li>
          <li>
          ...
          <li>
            Our Services may provide incomplete, incorrect, or offensive Output
            that does not represent our views. If Output references any third
            party products or services, it doesn’t mean the third party endorses
            or is affiliated with us.
          </li>
        </ul>
        <h2>Our IP Rights</h2>
        <p>
        ...
        <p>
          ...
          time. We reserve the right to suspend or terminate your access to our
        ...
        <p>
          We also may terminate your account if it has been inactive for over a
          year. If we do, we will provide you with advance notice.
        </p>
        <p>
        ...
        <p>
          ...
          EXCEED ONE HUNDRED DOLLARS ($100). THE LIMITATIONS IN THIS SECTION
        ...
        <p>
          ...
          out of or relating to these terms or any related Services, regardless
          of conflict of laws rules.
        </p>
        <p>
          <b>Forum Selection.</b> These disputes will be resolved exclusively in
          the federal or state courts of New York County, New York, USA, and you
          and the Company consent to personal jurisdiction in those courts.
        </p>
        <p>
          <b>CLASS ACTION AND JURY TRIAL WAIVERS</b>. You and the Company agree
          that Disputes must be brought on an individual basis only, and may not
          be brought as a plaintiff or class member in any purported class,
          consolidated, or representative proceeding. Class actions and
          representative actions are prohibited. Only individual relief is
          available. This does not prevent either party from participating in a
          class-wide settlement. You and the Company knowingly and irrevocably
        ...
        <p>
          ...
          working to develop and improve our Services. We may update these Terms
          or our Services accordingly from time to time. For example, we may
          make changes to these Terms or the Services due to:{" "}
        </p>
        <ul>
        ...
        <p>
          ...
          these Terms is determined to be invalid or unenforceable, that portion
          will be enforced to the maximum extent permissible and it will not
          affect the enforceability of any other terms.
        </p>
        <p>
          <b>Trade Controls.</b> You must comply with all applicable trade laws,
          including sanctions and export control laws. Our Services may not be
          used in or for the benefit of, or exported or re-exported to (a) any
          U.S. embargoed country or territory or (b) any individual or entity
          with whom dealings are prohibited or restricted under applicable trade
          laws. Our Services may not be used for any end use prohibited by
        ...
        <p>
          ...
          between you and the Company regarding the Services and, other than any
          Service-specific terms, supersedes any prior or contemporaneous
          agreements between you and the Company.
        </p>
        <p>
          <b>Governing Law.</b> New York law will govern these Terms except for
