  ...
  return (
    <Container containerStyles="p-24 pt-8">
      <div className="space-y-4">
        ...
        <h1 className="underline text-center">Privacy Policy</h1>
        <p>
          We at Cookout Ventures, LLC (together with our affiliates, the
          “Company”, “we”, “our”, or “us”) respect your privacy and are strongly
          committed to keeping secure any information we obtain from you or
          about you. This Privacy Policy describes our practices with respect to
        ...
        <p>
          <b>Personal Information You Provide:</b> We collect Personal
        ...
        <ul>
          <li>
            ...
            name, contact information, and account credentials (collectively,
            “Account Information”).
          </li>{" "}
          <li>
          ...
          <li>
            ...
            Instagram, Facebook, Threads, YouTube, TikTok, and LinkedIn. When
            you interact with our social media pages, we will collect Personal
          ...
          <li>
            Other Information You Provide: We collect other information that you
            may provide to us, such as when you participate in our events or
            surveys or provide us with information to establish your identity
        ...
        <ul>
          ...
          <li>
            ...
            device identifiers, and browser you are using. Information collected
          ...
          <li>
            ...
            improve your experience. A “cookie” is a piece of information sent
            to your browser by a website you visit. You can set your browser to
            accept all cookies, to reject all cookies, or to notify you whenever
            a cookie is offered so that you can decide each time whether to
            accept it. However, refusing a cookie may in some cases preclude you
            from using, or negatively affect the display or function of, a
            website or certain areas or features of a website. For more details
        ...
        <p>
          <b>Aggregated or De-Identified Information.</b> We may aggregate or
          de-identify Personal Information so that it may no longer be used to
          identify you and use such information to analyze the effectiveness of
          our Services, to improve and add features to our Services, to conduct
          research and for other similar purposes. In addition, from time to
          ...
          statistics with third parties, publish such aggregated information or
          make such aggregated information generally available. We may collect
          aggregated information through the Services, through cookies, and
          through other means described in this Privacy Policy. We will maintain
          and use de-identified information in anonymous or de-identified form
          and we will not attempt to reidentify the information, unless required
          by law.
        </p>
        <p>
          As noted above, we may use Content you provide us to improve our
          Services, for example to train the models that power Ask Nina. You can
          opt out of our use of your Content to train our models by emailing us
          at privacyataskina@gmail.com.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            to another provider (collectively, a “Transaction”), your Personal
          ...
          <li>
            ...
            common control with the Company. Our affiliates may use the Personal
        ...
        <ul>
          <li>
            Access your Personal Information and information relating to how it
            is processed.
          </li>
        ...
        <p>
          You can exercise some of these rights by submitting your request to
          privacyataskina@gmail.com.
        </p>
        <p>
          A note about accuracy: Services like Ask Nina generate responses by
          reading a user&apos;s request and, in response, predicting the words
          most likely to appear next. In some cases, the words most likely to
          appear next may not be the most factually accurate. For this reason,
          you should not rely on the factual accuracy of output from our models.
          If you notice that Ask Nina output contains factually inaccurate
          information about you and you would like us to correct the inaccuracy,
          you may submit a correction request to privacyataskina@gmail.com.
          ...
          may request that we remove your Personal Information from Ask
          Nina&apos;s sending a request to privacyataskina@gmail.com.
        </p>
        <h2>5. Additional U.S. state disclosures</h2>
        <p>
          The following table provides additional information about the
          categories of Personal Information we collect and how we disclose that
          information. You can read more about the Personal Information we
          collect in “Personal information we collect” above, how we use
          Personal Information in “How we use personal information” above, and
          how we retain Personal Information in “Security and Retention” below.
        </p>
        <table className="border text-left">
          ...
          <tr>
            <td>
              Identifiers, such as your name, contact details, IP address, and
              other device identifiers
            </td>
            <td>
              We may disclose this information to our affiliates, vendors and
              service providers to process in accordance with our instructions;
              to law enforcement and other third parties for the legal reasons
              described above; to parties involved in Transactions; to corporate
              administrators of enterprise or team accounts; and to other users
          ...
          <tr>
            ...
            <td>
              ...
              service providers to process in accordance with our instructions;
              to law enforcement and other third parties for the legal reasons
              described above; to parties involved in Transactions; and to other
              users and third parties you choose to share it with.
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              service providers to process in accordance with our instructions;
              to law enforcement and other third parties for the legal reasons
              described above; and to parties involved in Transactions.
            </td>
          </tr>
          <tr>
            <td>
        ...
        <ul>
          ...
          <li>
            The right to be free from discrimination relating to the exercise of
        ...
        <p>
          ...
          process sensitive Personal Information for the purposes of inferring
          characteristics about a consumer.
        </p>
        <p>
          <b>Exercising Your Rights.</b> To the extent applicable under local
          law, you can exercise privacy rights described in this section by
          submitting a request to privacyataskina@gmail.com.
        </p>
        <p>
          <b>Verification.</b> In order to protect your Personal Information
          from unauthorized access, change, or deletion, we may require you to
          verify your credentials before you can submit a request to know,
          correct, or delete Personal Information. If you do not have an account
          with us, or if we suspect fraudulent or malicious activity, we may ask
          you to provide additional Personal Information and proof of residency
          for verification. If we cannot verify your identity, we will not be
          able to honor your request.
        </p>
        <p>
          <b>Authorized Agents.</b> You may also submit a rights request through
          an authorized agent. If you do so, the agent must present signed
          written permission to act on your behalf and you may also be required
          to independently verify your identity and submit proof of your
          residency with us. Authorized agent requests can be submitted to
          privacyataskina@gmail.com.
        </p>
        <p>
          <b>Appeals.</b> Depending on where you live, you may have the right to
          appeal a decision we make relating to requests to exercise your rights
          under applicable local law. To appeal a decision, please send your
          request to privacyataskina@gmail.com.
        </p>
        <h2>6. Children</h2>
        <p>
          ...
          13. If you have reason to believe that a child under the age of 13 has
          provided Personal Information to us through the Services, please email
          us at privacyataskina@gmail.com. We will investigate any notification
          and if appropriate, delete the Personal Information from our systems.
          If you are 13 or older, but under 18, you must have permission from
          your parent or guardian to use our Services.
        </p>
        ...
        <p>
          We&apos;ll retain your Personal Information for only as long as we
          need in order to provide our Service to you, or for other legitimate
          ...
          Personal Information will depend on a number of factors, such as the
          amount, nature, and sensitivity of the information, the potential risk
          of harm from unauthorized use or disclosure, our purpose for
          processing the information, and any legal requirements.
        </p>
        <h2>9. International users</h2>
        <p>
          By using our Service, you understand and acknowledge that your
          Personal Information will be processed and stored in our facilities
          and servers in the United States and may be disclosed to our service
          providers and affiliates in other jurisdictions.
        </p>
        <p>
          <b>Legal Basis for Processing.</b> Our legal bases for processing your
          Personal Information include:{" "}
        </p>
        <ul>
          <li>
            Performance of a contract with you when we provide and maintain our
            Services. When we process Account Information, Content, and
            Technical Information solely to provide our Services to you, this
            information is necessary to be able to provide our Services. If you
          ...
          <li>
            ...
            fraud, or security risks, or in developing, improving, or promoting
            our Services, including when we train our models. This may include
            the processing of Account Information, Content, Social Information,
            and Technical Information. Read our instructions on how you can opt
            out of our use of your information to train our models.
          </li>
          <li>
        ...
        <p>
          ...
          safeguards for transferring Personal Information outside of certain
          countries. We will only transfer Personal Information pursuant to a
          legally valid transfer mechanism.
        </p>
        <p>
          <b>Data Protection Officer.</b> You can contact our data protection
          officer at privacyataskina@gmail.com in matters related to Personal
        ...
        <p>
          Please contact us at privacyataskina@gmail.com if you have any
