      ...
      <Container containerStyles="p-24 pt-8">
        <div className="space-y-4">
          ...
          <p>
            ...
            “Company”, “we”, “our”, or “us”) respect your privacy and are
            strongly committed to keeping secure any information we obtain from
            you or about you. This Privacy Policy describes our practices with
            respect to Personal Information we collect from or about you when
            you use our website, applications, and services (collectively,
            “Services”).
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              identity (collectively, “Other Information You Provide”)
            </li>
          </ul>
          <p>
            <b>
          ...
          <ul>
            ...
            <li>
              ...
              user agent and version, type of computer or mobile device, and
              your computer connection.
            </li>
            <li>
              Device Information: Includes name of the device, operating system,
              device identifiers, and browser you are using. Information
              collected may depend on the type of device you use and its
              settings.
            </li>
            <li>
              Cookies: We use cookies to operate and administer our Services,
              and improve your experience. A “cookie” is a piece of information
          ...
          <p>
            ...
            identify you and use such information to analyze the effectiveness
            of our Services, to improve and add features to our Services, to
            conduct research and for other similar purposes. In addition, from
            time to time, we may analyze the general behavior and
            ...
            generally available. We may collect aggregated information through
            the Services, through cookies, and through other means described in
          ...
          <p>
            ...
            Services, for example to train the models that power Ask Nina. You
            can opt out of our use of your Content to train our models by
            emailing us at privacyataskina@gmail.com.
          </p>
          ...
          <ul>
            <li>
              ...
              services, and other information technology providers, among
              others. Pursuant to our instructions, these parties will access,
            ...
            <li>
              ...
              including information about your interaction with our Services,
              with government authorities, industry peers, or other third
              parties (i) if required to do so by law or in the good faith
              belief that such action is necessary to comply with a legal
              obligation, (ii) to protect and defend our rights or property,
              (iii) if we determine, in our sole discretion, that there is a
              violation of our terms, policies, or the law; (iv) to detect or
              prevent fraud or other illegal activity; (v) to protect the
              safety, security, and integrity of our products, employees, or
              users, or the public, or (vi) to protect against legal liability.
            </li>
            <li>
              Affiliates: We may disclose Personal Information to our
              affiliates, meaning an entity that controls, is controlled by, or
              is under common control with the Company. Our affiliates may use
              the Personal Information we share in a manner consistent with this
              Privacy Policy.
            </li>
          </ul>
          <h2>4. Your rights</h2>
          ...
          <p>
            ...
            you should not rely on the factual accuracy of output from our
            models. If you notice that Ask Nina output contains factually
            inaccurate information about you and you would like us to correct
            the inaccuracy, you may submit a correction request to
            privacyataskina@gmail.com. Given the technical complexity of how our
            models work, we may not be able to correct the inaccuracy in every
            instance. In that case, you may request that we remove your Personal
            Information from Ask Nina&apos;s sending a request to
            privacyataskina@gmail.com.
          </p>
          ...
          <p>
            ...
            how we retain Personal Information in “Security and Retention”
            below.
          </p>
          <table className="border text-left">
            ...
            <tr>
              ...
              <td>
                ...
                instructions; to law enforcement and other third parties for the
                legal reasons described above; to parties involved in
                Transactions; to corporate administrators of enterprise or team
                accounts; and to other users and third parties you choose to
                share it with.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                service providers to process in accordance with our
                instructions; to law enforcement and other third parties for the
                legal reasons described above; and to parties involved in
                Transactions.
              </td>
            </tr>
            <tr>
          ...
          <p>
            ...
            will not be able to honor your request.
          </p>
          <p>
            <b>Authorized Agents.</b> You may also submit a rights request
            through an authorized agent. If you do so, the agent must present
            signed written permission to act on your behalf and you may also be
            ...
            to privacyataskina@gmail.com.
          </p>
          <p>
            <b>Appeals.</b> Depending on where you live, you may have the right
            to appeal a decision we make relating to requests to exercise your
            rights under applicable local law. To appeal a decision, please send
            your request to privacyataskina@gmail.com.
          </p>
          <h2>6. Children</h2>
          <p>
            ...
            age of 13. If you have reason to believe that a child under the age
            of 13 has provided Personal Information to us through the Services,
            please email us at privacyataskina@gmail.com. We will investigate
            any notification and if appropriate, delete the Personal Information
            from our systems. If you are 13 or older, but under 18, you must
          ...
          <p>
            <b>Legal Basis for Processing.</b> Our legal bases for processing
          ...
          <ul>
            ...
            <li>
              ...
              Information, and Technical Information. Read our instructions on
              how you can opt out of our use of your information to train our
              models.
            </li>
            <li>
            ...
            <li>
              ...
              or our affiliates&apos;, users&apos;, or third parties&apos;
